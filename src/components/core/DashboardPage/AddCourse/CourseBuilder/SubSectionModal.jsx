...
//       // in case of view and edit the subsection is already created 
//       // so set the value to perticular variable at first render 
//       if(view || edit){
...
//       formData.append("duration",20.10)
...
//         return
//       }
//       // title , duration, description, sectionId
//       // normal case that is create the subsectiion
//       const formData = new FormData();
//       formData.append("sectionId",modalData)
//       formData.append("title",data.lectureTitle)
//       formData.append("duration",20.15)
