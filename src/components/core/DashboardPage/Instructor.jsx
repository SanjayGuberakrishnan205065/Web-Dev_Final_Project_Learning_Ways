...
export default function Instructor() {
  ...
  return (
      ...
      
    {
      ...
      :courses.length>0
      ? (
        <div className=' flex flex-col gap-[380px] md:gap-1'>

        <div className="my-4 flex h-[450px] md:space-x-4 flex-col md:flex-row space-y-4  md:space-y-0">
            {/* Render chart / graph */}
        ...
        <div className="my-4 flex  flex-col md:flex-row md:items-start items-center  md:space-x-6  gap-y-6 ">

              {courses.slice(0, 3).map((course) => (
                <div key={course._id} className="md:w-1/3 w-full gap-y-4">
                  <img
