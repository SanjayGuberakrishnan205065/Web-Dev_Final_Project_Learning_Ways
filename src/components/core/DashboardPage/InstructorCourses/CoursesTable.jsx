                ...
                {course?.courseName}</p>
                    ...
                    {course?.status === COURSE_STATUS.DRAFT ? (
                      ...
                      Drafted</p>
                        ...
                        <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-richblack-700 px-2 py-[2px] text-[12px] font-medium text-yellow-200">
                  ...
                  <button
                    ...
                    onClick={() =>{
                      ...
                      setConfirmationModal({
                        ...
                        text2:
                          "All the data releted to this course will deleted ",
                        btn1Text: "Delete",
                        btn2Text: "Cancel",
                        btn1Handler: !loading
